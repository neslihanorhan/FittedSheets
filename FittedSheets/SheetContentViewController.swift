...
public class SheetContentViewController: UIViewController {
    ...
    private func setupChildViewController() {
        ...
        self.childContainerView.layer.compatibleMaskedCorners = [.layerMinXMaxYCorner, .layerMinXMinYCorner, .layerMaxXMinYCorner, .layerMaxXMaxYCorner]
    }
    ...
    private func setupContentView() {
        ...
        self.contentWrapperView.layer.compatibleMaskedCorners = [.layerMinXMaxYCorner, .layerMinXMinYCorner, .layerMaxXMinYCorner, .layerMaxXMaxYCorner]
    ...
    private func setupChildContainerView() {
        ...
        Constraints(for: self.childContainerView) { view in
            ...
            view.left.pinToSuperview()
            view.right.pinToSuperview()
            view.bottom.pinToSuperview(inset: options.bottomPadding, relation: .lessThanOrEqual).priority = .required
        }
    }
